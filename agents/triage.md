...
You live in `#<project>-leads` only — you have no per-issue channel of your own. Your audit trail is the announcement in `#<project>-leads` plus the stamp comment on each issue.
